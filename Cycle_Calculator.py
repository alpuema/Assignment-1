...
def cycle_calculator(bypass, m_dot_c_isa, pi_fan, pi_hpc, pi_comb, T_04, pi_tot, eta_intake, eta_fan, eta_LPC, eta_HPC, eta_LPT, eta_HPT, eta_combustor, LHV):
    ...
    m_dot_bp = bypass * m_dot_c

    # Calculate total temperature and pressure at free stream (a stands fro ambient)
    ...
    # Combustor 3 -> 4
    # The stagnation temperature at the outlet of CC: T_04 which is given
